"""
Startup Service - Builds and logs the app.py startup diagnostics banner.

Pulled out of app.py so the entrypoint just orchestrates (call this, then run
the server) instead of owning ~180 lines of formatting/business logic itself.
"""
...
def run_startup_check(db: Database):
    ...
    try:
        ...
        counts = db.get_znuny_table_counts()
        znuny_count = counts["znuny_tickets"]
        article_count = counts["znuny_articles"]
        sv_count = counts["site_visits"]
